...
final class SafeEnvelopeRevision4SourceTests: XCTestCase {
    ...
    func testCanonicalLiveTruthAndInvocationFormsContract() throws {
        ...
        XCTAssertTrue(inactiveNone.contains("pristine"))
        ...
        XCTAssertTrue(candidateAccepts("inactive", "pristine", "none", 10, projectionSignature))
        XCTAssertFalse(candidateAccepts("inactive", "pristine", "uuid", 10, projectionSignature))
        XCTAssertFalse(candidateAccepts("terminal", "pristine", "uuid", 10, projectionSignature))

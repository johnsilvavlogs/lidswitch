...
def main() -> int:
    ...
    require(candidate_manifest.get("envelope", {}).get("receipt_sha256") == files["package/build-envelope.json"]["sha256"] and package_manifest.get("envelope", {}).get("receipt_sha256") == files["package/build-envelope.json"]["sha256"], "manifest envelope mismatch")
